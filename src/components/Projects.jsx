        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full ">
            <div className="bg-amber-400/75 rounded-[30px] transition-transform duration-500 ease-in-out overflow-hidden hover:scale-105 hover:shadow-lg group"> {/*Project 1 as Card */}
              <div className="text-right text-cyan-300 p-6 pr-12"> {/* Title of Project */}
                <span>Website</span>
                <h3 className="text-2xl">UI/UX Portfolio</h3>
              </div>
              <div> {/* Description of Project */}
                <div className="">
                  <figure className="pl-12 relative w-[800px] h-80 transition-transform duration-500 ease-in-out group-hover:-translate-y-3">
                    <img
